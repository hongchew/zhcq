...
var ProductService = /** @class */ (function () {
    function ProductService(httpClient) {
        ...
        this.baseUrl = 'http://localhost:8080/ZhcqRetailSystem-war/Resources/Product';
    }
    ProductService.prototype.retrieveAllProducts = function () {
        return this.httpClient.get(this.baseUrl + '/retrieveAllProducts').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
    ProductService.prototype.retrieveAllUniqueProducts = function () {
        return this.httpClient.get(this.baseUrl + '/retrieveAllUniqueProducts').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
    ProductService.prototype.retrieveProductById = function (id) {
        return this.httpClient.get(this.baseUrl + '/retrieveProductById/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
    ProductService.prototype.retrieveProductByCat = function (catId) {
        return this.httpClient.get(this.baseUrl + '/retrieveProductByCat/' + catId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
